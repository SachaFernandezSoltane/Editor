...
public class ConcreteMementoTestUndo {
    ...
    @Test
    public void testUndoDoubleInsert() {
        invoker.setText("Test");
        invoker.playCommand("insert");
    ...
    @Test
    public void testUndoChangeSelection() {
        invoker.setText("Test");
        invoker.playCommand("insert");
    ...
    @Test
    public void testUndoMultipleInsertAndChangeSelection() {
        invoker.setText("Test");
        invoker.playCommand("insert");
        invoker.setBeginIndex(0);
        invoker.setEndIndex(2);
    ...
    @Test
    public void testUndoWithNoInsert(){
        invoker.playCommand("undo");
        assertEquals("",engine.getBufferContents());
    }

    @Test
    public void testUndoWithoutInsert(){
